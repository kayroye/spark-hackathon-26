  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
        ...
        <p className="text-lg text-slate-600 dark:text-slate-400">Loading your appointments...</p>
      </div>
    );
  }
        ...
        <Card className="bg-white shadow-md border-slate-200">
          <CardContent className="p-12 text-center space-y-6">
            ...
            <div className="space-y-3 max-w-md mx-auto">
              <h2 className="text-2xl font-semibold text-slate-800">No Upcoming Appointments</h2>
              <p className="text-lg text-slate-600">
            ...
            <div className="p-4 bg-teal-50 rounded-lg border border-teal-200 max-w-md mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="p-4 bg-white rounded-lg border border-slate-200 shadow-sm">
            <p className="text-lg text-slate-700">
              You have{' '}
              <span className="font-semibold text-teal-700">{scheduledAppointments.length}</span>{' '}
